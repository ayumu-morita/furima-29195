...
describe User do
  ...
  describe 'ユーザー新規登録' do
    context '新規登録がうまくいくとき' do
      it 'nick_nameとemail、passwordとpassword_confirmation、first_name、last_name、first_name_kana、last_name_kana、birthdayが存在すれば登録できる' do
    ...
    context '新規登録がうまくいかないとき' do
      ...
      it 'パスワードが半角英数混合でない(半角英字のみ)' do
        @user.password = 'bbbaaa'
        @user.password_confirmation = 'bbbaaa'
        @user.valid?
        expect(@user.errors.full_messages).to include('Password Include both letters and numbers')
      end
      it 'パスワードが半角英数混合でない(半角数字のみ)' do
